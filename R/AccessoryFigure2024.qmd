...
```{r}
color_family <- c("Proteaceae" = "#6699CC", "Fabacaeae" = "#661100", "Rutaceae" = "#117733", "Ericaceae" = "#882255", "Lamiaceae" = "#332288", "Thymelaeaceae" = "#00AAAB")
...
data <- SummarySpp[["mean"]] %>%
  ...
  left_join(species_full %>% dplyr::rename(species = Abbreviation) %>% dplyr::select(species, Family))
...
Panel3A <-
  ...
  scale_color_manual(value = color_family)  
