...
ggsave("ms/Accessory/output/Figure2.png", plot = Figure_2, width = 7, height = 3.5)
```
...
cowplot::save_plot("ms/Accessory/output/Figure3.png", Figure3, base_width = 6, base_height = 8.5)
...
ggsave("ms/Accessory/output/Figure4Nov.png", Figure4, width = 8.5, height= 4.5)
```
...
cowplot::save_plot("ms/Accessory/output/Figure5.png", Figure5, base_width = 8, base_height = 4)
```
