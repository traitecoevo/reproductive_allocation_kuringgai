...
repro_NP_investment <- 
  InvestIndPart %>%
    ...
    mutate(N_mass_repro_tissues = N_live*weight,
           P_mass_repro_tissues = P_live*weight) %>%
    ...
    select(-accessory_simple1, -accessory_simple2, -accessory_simple3)
```
...
nutrient_accessory_proportions <-
  temp %>%
    ...
    select(species,individual,prop_N_inv_propagules, prop_N_inv_prepollen_success, prop_N_inv_prepollen_abort,
           ...
           prop_N_prepollen_vs_required_success, prop_N_postpollen_vs_required_success,
           prop_N_propagule_vs_required_success,
           ...
           prop_P_prepollen_vs_required_success, prop_P_postpollen_vs_required_success,
           prop_P_propagule_vs_required_success)
